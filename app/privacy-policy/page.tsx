        ...
        <article className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none text-[#454238]">
            ...
            <ul>
              ...
              <li>
                <strong>Application</strong> refers to LeafyPal, the software program provided by the Company.
              </li>
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                refers to Piotr Mitręga, Łokietka 12e/15, Siemianowice Śląskie.
              </li>
              <li>
            ...
            <p>By email: piotrmitrega1@gmail.com</p>
          </div>
        </article>
      </main>
